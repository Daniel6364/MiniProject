...
public class PurchaseDAO {
	...
	public void insertPurchase(Purchase purchase) throws Exception {
		...
		System.out.println("[insertPurchase Start]");
	...
	public Purchase findPurchase(int tranNo) throws Exception {
		...
		System.out.println("[findPurchase Start]");
	...
	// 3. findPurcase2
		public Purchase findPurchase2(int prodNo) throws Exception {
			...
			System.out.println("[findPurchase2 Start]");
	...
	public Map<String, Object> getPurchaseList(Search search, String buyerId) throws Exception {
		...
		System.out.println("[getPurchaseList Start]");
		...
		System.out.println("1.[PurchaseDAO :: Original SQL] :: " + sql);

		int totalCount = this.getTotalCount(sql);
		System.out.println("2.[PurchaseDAO :: totalCount] :: " + totalCount);
		...
		System.out.println("3.[totalCount value in ProductDAO.java] : " + map.get("totalCount"));

		map.put("list", list);
		System.out.println("4.[List value contained currentPage in PurchaseDAO.java] : " + map.get("list"));
